...
pass via ``quality --audio``/``--reference-stm``: DER is scored, WER is omitted.
    ...
    python -m asr_diar_server.bench.utils.make_rttm_clip \
...
from asr_diar_server.bench.stm import rttm_to_stm, slice_stm_window
from asr_diar_server.bench.utils.make_ami_clip import cut_audio_clip
