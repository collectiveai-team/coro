...
subcommand's ``--audio`` / ``--reference-stm`` flags:
    ...
    asr-diar-bench quality --audio IB4001_180_60.wav --reference-stm IB4001_180_60.ref.stm
...
from asr_diar_server.bench.ami import clip_reference_stm, get_audio_path
