...
from asr_diar_server.bench.stm import ami_meeting_to_stm, slice_stm_window
from asr_diar_server.bench.utils.ami_audios_download import (
...
AMI_GROUPS: dict[str, list[str]] = {
    ...
    "IN": [
        "IN1001", "IN1002", "IN1003", "IN1004",
        "IN1005", "IN1006", "IN1007", "IN1008",
    ],
    "ES": [
        "ES2002a", "ES2002b", "ES2003a", "ES2003b",
        "ES2004a", "ES2004b", "ES2005a", "ES2005b",
        "ES2006a", "ES2006b", "ES2007a", "ES2007b",
        "ES2008a", "ES2008b", "ES2009a", "ES2009b",
        "ES2010a", "ES2010b", "ES2011a", "ES2011b",
        "ES2012a", "ES2012b", "ES2013a", "ES2013b",
        "ES2014a", "ES2014b", "ES2015a", "ES2015b",
        "ES2016a", "ES2016b",
    ],
    "IS": [
    ...
    "EN": [
        "EN2001a", "EN2001b", "EN2002a", "EN2002b",
        "EN2002c", "EN2002d",
    ],
}
...
AMI_PRESETS: dict[str, list[str]] = {
    ...
    "eval": [
        m for group in ("ES", "IS") for m in AMI_GROUPS[group]
    ],
